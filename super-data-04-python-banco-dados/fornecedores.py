...
def consulta_fornecedor_por_cnpj(cnpj: str):
...
def cadastrar_fornecedor():
    ...
    razao_social, nome_fantasia, cep, numero = consulta_fornecedor_por_cnpj(cnpj)
    ...
    with conectar() as conexao:
        with conexao.cursor() as cursor:
            ...
            """, (cnpj, razao_social, nome_fantasia, cep, numero))
            conexao.commit()
    print("Fornecedore cadastrado com sucesso")
